...
# 用法: bash scripts/cluster/27Bpcbasft_lora_standard.sh
# 跳过数据转换: BUILD_DATASET=0 bash scripts/cluster/27Bpcbasft_lora_standard.sh
# 不合并 LoRA: MERGE_LORA_AFTER=0 bash scripts/cluster/27Bpcbasft_lora_standard.sh
