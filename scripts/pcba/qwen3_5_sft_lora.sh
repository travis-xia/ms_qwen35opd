#!/usr/bin/env bash
# Qwen3.5-4B PDF-RAG SFT（LoRA）；跳过数据组装: BUILD_DATASET=0 bash scripts/cluster/qwen3_5_sft_lora.sh
# 不合并、只保留 LoRA checkpoint: MERGE_LORA_AFTER=0 bash scripts/cluster/qwen3_5_sft_lora.sh
