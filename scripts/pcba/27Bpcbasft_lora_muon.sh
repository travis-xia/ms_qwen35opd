...
# 基于 scripts/cluster/27Bpcbasft_lora.sh；去掉 vit_lr/aligner_lr（与 multimodal 分组 LR 互斥）
#
# 跳过数据组装: BUILD_DATASET=0 bash scripts/cluster/27Bpcbasft_lora_muon.sh
# 不合并 checkpoint: MERGE_LORA_AFTER=0 bash scripts/cluster/27Bpcbasft_lora_muon.sh
